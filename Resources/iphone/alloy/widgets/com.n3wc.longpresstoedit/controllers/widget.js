...
function Controller() {
    ...
    function switchToInputFunc() {
        ...
        if (true && "switch" !== inputTypeSetting && "slider" !== inputTypeSetting) {
            var doneButton = Ti.UI.createButton({
                systemButton: Ti.UI.iPhone.SystemButton.DONE
            });
            doneButton.addEventListener("click", backToText);
            var keyboard_btns = [ Titanium.UI.createButton({
    ...
    new (require("alloy/widget"))("com.n3wc.longpresstoedit");
    this.__widgetId = "com.n3wc.longpresstoedit";
